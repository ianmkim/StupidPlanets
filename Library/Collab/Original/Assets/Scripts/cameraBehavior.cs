    ...
    void onClick()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.transform.gameObject.tag == "Planet")
            {
                ...
                /* TUTORIAL TEXT WHEN PLANET IS CLICKED */
                TextController.txt.killAll();
                TextController.txt.newText("You clicked on a planet! rotate the camera with your left mouse button and hit \"esc\" to go back to the solar view", 500, 500);
            }
        }
    }
